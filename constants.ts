...
// 주재료 키워드 매핑 (단일 소스 — autoClassifyService 기준 + sheetsSerializer '설렁탕' 병합)
export const INGREDIENT_KEYWORDS: Record<string, string[]> = {
  beef: ['소고기', '한우', '불고기', '갈비', '사골', '차돌', '우삼겹', '소불고기', '설렁탕'],
  pork: ['한돈', '돼지', '제육', '삼겹', '탕수', '돈까스', '수육', '보쌈', '족발', '돈불고기'],
  chicken: ['닭', '치킨', '닭볶음', '닭갈비', '닭강정', '닭가슴'],
  fish: [
    '동태',
    '오징어',
    '새우',
  ...
  vegetable: ['나물', '시래기', '애호박', '양배추', '콩나물', '숙주', '브로콜리', '시금치', '깻잎', '상추'],
};
