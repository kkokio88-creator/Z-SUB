...
import { TrendingUp, DollarSign, PieChart as PieChartIcon, ArrowUpRight, ArrowDownRight, CreditCard, Activity, Download } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
           <div className="flex justify-between items-start mb-2">
              ...
              <div className="p-2 bg-orange-50 text-orange-600 rounded-lg"><PieChartIcon className="w-5 h-5" /></div>
           </div>
            ...
            <div className="flex-1 min-h-0">
               <ResponsiveContainer width="100%" height="100%">
                  <ComposedChart data={MONTHLY_FINANCIALS} margin={{ top: 20, right: 20, bottom: 20, left: 20 }}>
                     ...
                     <YAxis tick={{fontSize: 12, fill: '#6b7280'}} axisLine={false} tickLine={false} tickFormatter={(value) => `${value / 1000000}M`} />
                     <Tooltip 
