...
import { SUBSCRIBER_MOCK_DATA } from '../data/mockData';
...
const DATA: SubscriberStats[] = SUBSCRIBER_MOCK_DATA;
                ...
                {DATA.map(item => (
                  ...
                  >
                    ...
                    <td className="p-3 text-center">
                      <span
                        className={`px-2 py-0.5 rounded text-xs font-bold ${item.satisfaction >= 4.5 ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700'}`}
                      >
                        {item.satisfaction}
                      </span>
                    </td>
                ...
                {selectedPlan.demographics.map((demo, idx) => (
                  <div key={idx} className="flex items-center gap-2 text-xs">
                    ...
                    <div className="flex-1 h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-500 rounded-full" style={{ width: `${demo.value}%` }}></div>
                    </div>
