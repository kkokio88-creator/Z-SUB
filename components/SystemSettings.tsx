...
import { Save, BrainCircuit, Shield, Database, CheckCircle, AlertCircle, RefreshCw, FileSpreadsheet, Server, Activity } from 'lucide-react';
...
- 매운맛은 전면 배제하되, 간장 베이스로 대체.`);
  ...
  const getStatusIcon = (status: string) => {
      switch(status) {
          case 'loading': return <RefreshCw className="w-4 h-4 animate-spin text-blue-500" />;
                   ...
                   <div className="bg-purple-50 p-4 rounded-lg border border-purple-100 flex gap-3 items-start">
                      ...
                      <div>
                          ...
                          <p className="text-xs text-purple-700 mt-1">
                              복잡한 수치 설정 대신, 영양사님께서 후임자에게 인수인계 하듯이 상세한 규칙을 글로 적어주세요. AI가 문맥을 이해하고 반영합니다.
                          </p>
                      </div>
                   </div>
                   ...
                   <div className="p-5 border border-gray-200 rounded-xl bg-white shadow-sm">
                        <div className="flex justify-between items-start mb-4">
                            <div className="flex items-center gap-2">
                                <div className="p-2 bg-blue-100 rounded-lg"><BrainCircuit className="w-5 h-5 text-blue-600" /></div>
                                <div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <span className="inline-flex items-center px-3 rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-xs">POST</span>
                                    <input 
                                        type="text" 
                                        value={misApiUrl}
                            ...
                            <div>
                                ...
                                <div className="flex gap-2">
                                    <span className="inline-flex items-center px-3 rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-xs">PUT</span>
                                    <input 
                                        type="text" 
                                        value={zppsApiUrl}
